...
/// Usage : HDevToast.Show(fenêtre, "Nouveau message", "De : Julien", "📧",
///     onClick: () => ...);
/// </summary>
public static class HDevToast
{
        ...
        string? icon = null, TimeSpan? duration = null, Action? onClick = null)
    {
        ...
        toast.PointerPressed += (s, e) =>
        {
            ...
            if (e.Source is Visual v && v.GetType() == typeof(HDevEditorGlyphButton))
                return;
            onClick?.Invoke();
            Close();
            e.Handled = true;
        ...
        if (toast.Tag is HDevEditorGlyphButton closeButton)
    ...
    {
        var closeButton = new HDevEditorGlyphButton { Glyph = "✕", GlyphSize = 10, Width = 22, Height = 22 };
        ...
        textPanel.Children.Add(new TextBlock
        {
            Text = message,
            FontSize = 12,
            Foreground = new SolidColorBrush(HDevTheme.Text.Secondary),
        ...
        var toast = new Border
        {
            ...
            BoxShadow = new BoxShadows(new BoxShadow
            {
                ...
                Color = HDevTheme.Shadow.ColorStrong
            }),
            Child = row,
