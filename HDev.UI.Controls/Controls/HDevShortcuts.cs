...
/// </summary>
public sealed class HDevShortcutManager
{
    private static readonly ConditionalWeakTable<TopLevel, HDevShortcutManager> Managers = new();
    ...
    private HDevShortcutManager(TopLevel topLevel)
    {
    ...
    public static HDevShortcutManager GetFor(TopLevel topLevel)
        => Managers.GetValue(topLevel, tl => new HDevShortcutManager(tl));
    ...
    {
        private readonly HDevShortcutManager _manager;
        private readonly Binding _binding;

        public Registration(HDevShortcutManager manager, Binding binding)
        {
            _manager = manager;
            _binding = binding;
        }
