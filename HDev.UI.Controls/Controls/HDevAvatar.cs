...
/// <summary>Taille d'un HDevAvatar</summary>
public enum AvatarSize
{
    /// <summary>24 px (listes denses)</summary>
    Small,
    /// <summary>32 px (défaut — aligné sur la pastille de HDevListView)</summary>
    Medium,
...
/// </summary>
public class HDevAvatar : Control
{
    ...
    public override void Render(DrawingContext context)
    {
        ...
        if (_image != null)
        {
            ...
            context.DrawEllipse(null, new Pen(new SolidColorBrush(HDevTheme.Border.Subtle), 1),
        ...
        else
        {
            ...
            var initials = new FormattedText(EffectiveInitials,
                ...
                new Typeface(HDevTheme.Typography.FontFamily, FontStyle.Normal, FontWeight.SemiBold),
        ...
        if (_status != AvatarStatus.None)
        {
            ...
            {
                AvatarStatus.Online => HDevTheme.Accent.Success,
                AvatarStatus.Away => HDevTheme.Accent.Warning,
                AvatarStatus.Busy => HDevTheme.Accent.Error,
                _ => HDevTheme.Text.Disabled,
            };
            context.DrawEllipse(new SolidColorBrush(dotColor),
                new Pen(new SolidColorBrush(HDevTheme.Background.Panel), 2),
                dotCenter, dotR, dotR);
        }
    }
}
