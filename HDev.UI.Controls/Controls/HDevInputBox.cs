...
/// <summary>
/// Boîte de saisie modale (équivalent XtraInputBox) : libellé + HDevTextBox +
/// OK/Annuler. Retourne null si annulée.
/// Usage : var url = await HDevInputBox.ShowAsync(owner, "Adresse du lien :",
///     "Insérer un lien", "https://");
/// </summary>
public class HDevInputBox : HDevWindow
{
    private string? _result;
    private readonly HDevTextBox _input;

    private HDevInputBox(string prompt, string caption, string initialValue)
    {
        Title = caption;
        Width = 440;
        ...
        _input = new HDevTextBox { Text = initialValue };

        var ok = new HDevButton { Text = "OK", Variant = ButtonVariant.Primary, Width = 96 };
        var cancel = new HDevButton { Text = "Annuler", Variant = ButtonVariant.Secondary, Width = 96 };
    ...
    {
        var box = new HDevInputBox(prompt, caption, initialValue);
