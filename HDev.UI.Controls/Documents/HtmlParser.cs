...
/// <summary>
/// Parseur HTML en sous-ensemble sanitisé → HDevDocument.
...
public static class HtmlParser
{
    ...
    public static HDevDocument Parse(string html) => ParseCore(html, null);
    ...
    private static HDevDocument ParseCore(string html, List<HtmlDiagnostic>? diagnostics)
    {
        var document = new HDevDocument();
