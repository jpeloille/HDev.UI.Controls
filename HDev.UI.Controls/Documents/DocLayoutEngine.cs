...
/// <summary>
/// Pose un HDevDocument dans une largeur donnée : wrapping par TextLayout
...
public class DocLayoutEngine
{
    ...
    private DocLayoutEngine(DocStyle baseStyle)
    {
        ...
        _fontFamily = baseStyle.FontFamily ?? HDevTheme.Typography.FontFamily;
        _monoFamily = "monospace";
    }

    public static DocLayoutResult Layout(HDevDocument document, double width)
    {
    ...
    private double LayoutParagraph(DocParagraph paragraph, double x, double y, double width)
    {
        ...
        var layout = new TextLayout(
            ...
            fontSize,
            new SolidColorBrush(_baseStyle.Foreground ?? HDevTheme.Text.Primary),
            paragraph.Alignment,
            TextWrapping.Wrap,
            maxWidth: width,
    ...
    private double LayoutCode(DocCodeBlock code, double x, double y, double width)
    {
        ...
        {
            Color = HDevTheme.Background.Toolbar,
        ...
        BuildParagraphRuns(DocParagraph paragraph)
    {
        ...
        void AppendRun(DocRun run, string? href)
        {
            ...
            var foreground = isLink
                ...
                : style.Foreground ?? HDevTheme.Text.Primary;
            ...
            switch (box)
            {
                ...
                case DocImageBox placeholder:
                    context.DrawRectangle(
                        new SolidColorBrush(HDevTheme.Background.Toolbar),
                    ...
                    var alt = new TextLayout(
                        ...
                        new Typeface(HDevTheme.Typography.FontFamily), 12,
                        new SolidColorBrush(HDevTheme.Text.Secondary),
                ...
                case DocRuleBox:
                case DocGridLineBox:
                    context.FillRectangle(new SolidColorBrush(HDevTheme.Border.Subtle), bounds);
                    break;

                case DocQuoteBarBox:
                    context.FillRectangle(new SolidColorBrush(HDevTheme.Border.Default), bounds, 1.5f);
                    break;
            }
        }
    }
