...
/// </summary>
public class ProDataGridColumnHeader : TemplatedControl
{
    ...
    public static readonly StyledProperty<GridColumn?> ColumnProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, GridColumn?>(nameof(Column));

    public static readonly StyledProperty<string> HeaderTextProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, string>(nameof(HeaderText), string.Empty);

    public static readonly StyledProperty<ListSortDirection?> SortDirectionProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, ListSortDirection?>(nameof(SortDirection));

    public static readonly StyledProperty<int> SortIndexProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, int>(nameof(SortIndex), -1);

    public static readonly StyledProperty<bool> AllowSortProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, bool>(nameof(AllowSort), true);

    public static readonly StyledProperty<bool> AllowResizeProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, bool>(nameof(AllowResize), true);

    public static readonly StyledProperty<bool> AllowReorderProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, bool>(nameof(AllowReorder), true);

    public static readonly StyledProperty<bool> ShowFilterButtonProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, bool>(nameof(ShowFilterButton), false);

    public static readonly StyledProperty<bool> IsFilteredProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, bool>(nameof(IsFiltered), false);

    public static readonly StyledProperty<bool> IsDragOverLeftProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, bool>(nameof(IsDragOverLeft), false);

    public static readonly StyledProperty<bool> IsDragOverRightProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, bool>(nameof(IsDragOverRight), false);

    public static readonly StyledProperty<bool> IsFrozenProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, bool>(nameof(IsFrozen), false);

    public static readonly StyledProperty<bool> IsPositionLockedProperty =
        AvaloniaProperty.Register<ProDataGridColumnHeader, bool>(nameof(IsPositionLocked), false);
    ...
    public static readonly RoutedEvent<ColumnEventArgs> SortRequestedEvent =
        RoutedEvent.Register<ProDataGridColumnHeader, ColumnEventArgs>(
    ...
    public static readonly RoutedEvent<ColumnResizeEventArgs> ResizeCompletedEvent =
        RoutedEvent.Register<ProDataGridColumnHeader, ColumnResizeEventArgs>(
    ...
    public static readonly RoutedEvent<ColumnReorderEventArgs> ReorderCompletedEvent =
        RoutedEvent.Register<ProDataGridColumnHeader, ColumnReorderEventArgs>(
    ...
    public static readonly RoutedEvent<ColumnFreezeEventArgs> FreezeRequestedEvent =
        RoutedEvent.Register<ProDataGridColumnHeader, ColumnFreezeEventArgs>(
    ...
    static ProDataGridColumnHeader()
    {
        ColumnProperty.Changed.AddClassHandler<ProDataGridColumnHeader>((header, e) => header.OnColumnChanged(e));
    }
