...
/// </summary>
public class ProDataGridGroupPanel : TemplatedControl
{
    ...
    public static readonly StyledProperty<ObservableCollection<GridColumn>> GroupedColumnsProperty =
        AvaloniaProperty.Register<ProDataGridGroupPanel, ObservableCollection<GridColumn>>(
            nameof(GroupedColumns), new ObservableCollection<GridColumn>());

    public static readonly StyledProperty<string> PlaceholderTextProperty =
        AvaloniaProperty.Register<ProDataGridGroupPanel, string>(
    ...
    public static readonly StyledProperty<bool> IsDragOverProperty =
        AvaloniaProperty.Register<ProDataGridGroupPanel, bool>(nameof(IsDragOver), false);
    ...
    public static readonly RoutedEvent<GroupColumnEventArgs> ColumnGroupedEvent =
        RoutedEvent.Register<ProDataGridGroupPanel, GroupColumnEventArgs>(
