...
/// </summary>
public class ProDataGridRow : TemplatedControl
{
    ...
    public static readonly StyledProperty<int> RowIndexProperty =
        AvaloniaProperty.Register<ProDataGridRow, int>(nameof(RowIndex), -1);

    public static readonly StyledProperty<bool> IsSelectedProperty =
        AvaloniaProperty.Register<ProDataGridRow, bool>(nameof(IsSelected), false);

    public static readonly StyledProperty<bool> IsCurrentProperty =
        AvaloniaProperty.Register<ProDataGridRow, bool>(nameof(IsCurrent), false);

    public static readonly StyledProperty<bool> IsAlternateProperty =
        AvaloniaProperty.Register<ProDataGridRow, bool>(nameof(IsAlternate), false);

    public static readonly StyledProperty<bool> IsEditingProperty =
        AvaloniaProperty.Register<ProDataGridRow, bool>(nameof(IsEditing), false);

    public static readonly StyledProperty<double> RowHeightProperty =
        AvaloniaProperty.Register<ProDataGridRow, double>(nameof(RowHeight), 36);

    public static readonly StyledProperty<bool> ShowRowNumberProperty =
        AvaloniaProperty.Register<ProDataGridRow, bool>(nameof(ShowRowNumber), false);

    public static readonly StyledProperty<bool> ShowRowIndicatorProperty =
        AvaloniaProperty.Register<ProDataGridRow, bool>(nameof(ShowRowIndicator), true);

    public static readonly StyledProperty<GridColumnCollection?> ColumnsProperty =
        AvaloniaProperty.Register<ProDataGridRow, GridColumnCollection?>(nameof(Columns));

    public static readonly StyledProperty<IBrush?> SelectedBackgroundProperty =
        AvaloniaProperty.Register<ProDataGridRow, IBrush?>(nameof(SelectedBackground));

    public static readonly StyledProperty<IBrush?> AlternateBackgroundProperty =
        AvaloniaProperty.Register<ProDataGridRow, IBrush?>(nameof(AlternateBackground));

    public static readonly StyledProperty<IBrush?> HoverBackgroundProperty =
        AvaloniaProperty.Register<ProDataGridRow, IBrush?>(nameof(HoverBackground));
    ...
    public static readonly RoutedEvent<RowEventArgs> RowClickEvent =
        RoutedEvent.Register<ProDataGridRow, RowEventArgs>(
    ...
    static ProDataGridRow()
    {
        IsSelectedProperty.Changed.AddClassHandler<ProDataGridRow>((row, e) =>
            row.PseudoClasses.Set(PC_Selected, (bool)e.NewValue!));

        IsCurrentProperty.Changed.AddClassHandler<ProDataGridRow>((row, e) =>
            row.PseudoClasses.Set(PC_Current, (bool)e.NewValue!));

        IsAlternateProperty.Changed.AddClassHandler<ProDataGridRow>((row, e) =>
            row.PseudoClasses.Set(PC_Alternate, (bool)e.NewValue!));

        IsEditingProperty.Changed.AddClassHandler<ProDataGridRow>((row, e) =>
