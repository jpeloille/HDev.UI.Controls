...
/// </summary>
public class ProDataGridCell : TemplatedControl
{
    ...
    public static readonly StyledProperty<GridColumn?> ColumnProperty =
        AvaloniaProperty.Register<ProDataGridCell, GridColumn?>(nameof(Column));

    public static readonly StyledProperty<object?> ValueProperty =
        AvaloniaProperty.Register<ProDataGridCell, object?>(nameof(Value));

    public static readonly StyledProperty<object?> RowDataProperty =
        AvaloniaProperty.Register<ProDataGridCell, object?>(nameof(RowData));

    public static readonly StyledProperty<bool> IsSelectedProperty =
        AvaloniaProperty.Register<ProDataGridCell, bool>(nameof(IsSelected), false);

    public static readonly StyledProperty<bool> IsEditingProperty =
        AvaloniaProperty.Register<ProDataGridCell, bool>(nameof(IsEditing), false);

    public static readonly StyledProperty<bool> IsReadOnlyProperty =
        AvaloniaProperty.Register<ProDataGridCell, bool>(nameof(IsReadOnly), false);

    public static readonly StyledProperty<TextAlignment> TextAlignmentProperty =
        AvaloniaProperty.Register<ProDataGridCell, TextAlignment>(nameof(TextAlignment), TextAlignment.Left);

    public static readonly StyledProperty<string?> DisplayTextProperty =
        AvaloniaProperty.Register<ProDataGridCell, string?>(nameof(DisplayText));
    ...
    public static readonly RoutedEvent<CellEventArgs> CellClickEvent =
        RoutedEvent.Register<ProDataGridCell, CellEventArgs>(
    ...
    public static readonly RoutedEvent<CellValueChangedEventArgs> ValueChangedEvent =
        RoutedEvent.Register<ProDataGridCell, CellValueChangedEventArgs>(
    ...
    static ProDataGridCell()
    {
        IsSelectedProperty.Changed.AddClassHandler<ProDataGridCell>((cell, e) =>
            cell.PseudoClasses.Set(PC_Selected, (bool)e.NewValue!));

        IsEditingProperty.Changed.AddClassHandler<ProDataGridCell>((cell, e) =>
        {
            cell.PseudoClasses.Set(PC_Editing, (bool)e.NewValue!);
            cell.OnEditingChanged((bool)e.NewValue!);
        });

        IsReadOnlyProperty.Changed.AddClassHandler<ProDataGridCell>((cell, e) =>
            cell.PseudoClasses.Set(PC_ReadOnly, (bool)e.NewValue!));

        ColumnProperty.Changed.AddClassHandler<ProDataGridCell>((cell, e) => cell.OnColumnChanged());
        ValueProperty.Changed.AddClassHandler<ProDataGridCell>((cell, e) => cell.UpdateDisplayText());
        RowDataProperty.Changed.AddClassHandler<ProDataGridCell>((cell, e) => cell.UpdateValue());
    }
