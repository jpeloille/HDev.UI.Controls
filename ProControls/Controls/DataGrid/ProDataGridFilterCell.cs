...
/// </summary>
public class ProDataGridFilterCell : TemplatedControl
{
    ...
    public static readonly StyledProperty<GridColumn?> ColumnProperty =
        AvaloniaProperty.Register<ProDataGridFilterCell, GridColumn?>(nameof(Column));

    public static readonly StyledProperty<string> FilterTextProperty =
        AvaloniaProperty.Register<ProDataGridFilterCell, string>(nameof(FilterText), string.Empty);
    ...
    public static readonly RoutedEvent<FilterChangedEventArgs> FilterChangedEvent =
        RoutedEvent.Register<ProDataGridFilterCell, FilterChangedEventArgs>(
