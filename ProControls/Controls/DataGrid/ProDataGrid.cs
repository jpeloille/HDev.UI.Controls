...
using SelectionMode = ProControls.Models.DataGrid.SelectionMode;
...
/// </summary>
public class ProDataGrid : TemplatedControl
{
    ...
    private ProDataGridGroupPanel? _groupPanel;
    ...
    public static readonly StyledProperty<IEnumerable?> ItemsSourceProperty =
        AvaloniaProperty.Register<ProDataGrid, IEnumerable?>(nameof(ItemsSource));

    public static readonly StyledProperty<GridColumnCollection> ColumnsProperty =
        AvaloniaProperty.Register<ProDataGrid, GridColumnCollection>(nameof(Columns));

    public static readonly StyledProperty<object?> SelectedItemProperty =
        AvaloniaProperty.Register<ProDataGrid, object?>(nameof(SelectedItem),
            defaultBindingMode: BindingMode.TwoWay);

    public static readonly StyledProperty<IList?> SelectedItemsProperty =
        AvaloniaProperty.Register<ProDataGrid, IList?>(nameof(SelectedItems));

    public static readonly StyledProperty<SelectionMode> SelectionModeProperty =
        AvaloniaProperty.Register<ProDataGrid, SelectionMode>(nameof(SelectionMode), SelectionMode.Single);

    public static readonly StyledProperty<double> RowHeightProperty =
        AvaloniaProperty.Register<ProDataGrid, double>(nameof(RowHeight), 36);

    public static readonly StyledProperty<double> HeaderHeightProperty =
        AvaloniaProperty.Register<ProDataGrid, double>(nameof(HeaderHeight), 40);

    public static readonly StyledProperty<bool> ShowHeaderProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(ShowHeader), true);

    public static readonly StyledProperty<bool> ShowFilterRowProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(ShowFilterRow), false);

    public static readonly StyledProperty<bool> ShowGroupPanelProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(ShowGroupPanel), false);

    public static readonly StyledProperty<bool> AllowSortingProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(AllowSorting), true);

    public static readonly StyledProperty<bool> AllowFilteringProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(AllowFiltering), true);

    public static readonly StyledProperty<bool> AllowGroupingProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(AllowGrouping), true);

    public static readonly StyledProperty<bool> AllowEditingProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(AllowEditing), true);

    public static readonly StyledProperty<bool> AllowColumnResizingProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(AllowColumnResizing), true);

    public static readonly StyledProperty<bool> AllowColumnReorderingProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(AllowColumnReordering), true);

    public static readonly StyledProperty<bool> AutoGenerateColumnsProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(AutoGenerateColumns), true);

    public static readonly StyledProperty<bool> IsVirtualizingProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(IsVirtualizing), true);

    public static readonly StyledProperty<bool> ShowRowNumbersProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(ShowRowNumbers), false);

    public static readonly StyledProperty<bool> ShowRowIndicatorProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(ShowRowIndicator), true);

    public static readonly StyledProperty<IBrush?> AlternateRowBackgroundProperty =
        AvaloniaProperty.Register<ProDataGrid, IBrush?>(nameof(AlternateRowBackground));

    public static readonly StyledProperty<IBrush?> SelectedRowBackgroundProperty =
        AvaloniaProperty.Register<ProDataGrid, IBrush?>(nameof(SelectedRowBackground));

    public static readonly StyledProperty<IBrush?> HoverRowBackgroundProperty =
        AvaloniaProperty.Register<ProDataGrid, IBrush?>(nameof(HoverRowBackground));

    public static readonly StyledProperty<IBrush?> GridLinesColorProperty =
        AvaloniaProperty.Register<ProDataGrid, IBrush?>(nameof(GridLinesColor));

    public static readonly StyledProperty<GridLinesVisibility> GridLinesVisibilityProperty =
        AvaloniaProperty.Register<ProDataGrid, GridLinesVisibility>(nameof(GridLinesVisibility), GridLinesVisibility.Horizontal);

    public static readonly StyledProperty<int> FrozenColumnCountProperty =
        AvaloniaProperty.Register<ProDataGrid, int>(nameof(FrozenColumnCount), 0);

    public static readonly StyledProperty<string?> EmptyContentProperty =
        AvaloniaProperty.Register<ProDataGrid, string?>(nameof(EmptyContent), "No data to display");

    public static readonly StyledProperty<bool> IsLoadingProperty =
        AvaloniaProperty.Register<ProDataGrid, bool>(nameof(IsLoading), false);

    public static readonly StyledProperty<string?> LoadingTextProperty =
        AvaloniaProperty.Register<ProDataGrid, string?>(nameof(LoadingText), "Loading...");
    ...
    public static readonly StyledProperty<ICommand?> RowDoubleClickCommandProperty =
        AvaloniaProperty.Register<ProDataGrid, ICommand?>(nameof(RowDoubleClickCommand));

    public static readonly StyledProperty<ICommand?> SelectionChangedCommandProperty =
        AvaloniaProperty.Register<ProDataGrid, ICommand?>(nameof(SelectionChangedCommand));

    public static readonly StyledProperty<ICommand?> CellEditEndingCommandProperty =
        AvaloniaProperty.Register<ProDataGrid, ICommand?>(nameof(CellEditEndingCommand));
    ...
    public static readonly RoutedEvent<global::Avalonia.Controls.SelectionChangedEventArgs> SelectionChangedEvent =
        RoutedEvent.Register<ProDataGrid, global::Avalonia.Controls.SelectionChangedEventArgs>(
    ...
    public static readonly RoutedEvent<CellEditEventArgs> CellEditStartingEvent =
        RoutedEvent.Register<ProDataGrid, CellEditEventArgs>(
    ...
    public static readonly RoutedEvent<ColumnEventArgs> ColumnSortedEvent =
        RoutedEvent.Register<ProDataGrid, ColumnEventArgs>(
    ...
    static ProDataGrid()
    {
        ItemsSourceProperty.Changed.AddClassHandler<ProDataGrid>((grid, e) => grid.OnItemsSourceChanged(e));
        SelectionModeProperty.Changed.AddClassHandler<ProDataGrid>((grid, e) => grid.OnSelectionModeChanged(e));
        SelectedItemProperty.Changed.AddClassHandler<ProDataGrid>((grid, e) => grid.OnSelectedItemChanged(e));
    }
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        _groupPanel = e.NameScope.Find<ProDataGridGroupPanel>("PART_GroupPanel");
        ...
        // Listen to column header events (bubbled from ProDataGridColumnHeader)
        AddHandler(ProDataGridColumnHeader.SortRequestedEvent, OnColumnSortRequested);
        AddHandler(ProDataGridColumnHeader.ResizeCompletedEvent, OnColumnResizeCompleted);
        AddHandler(ProDataGridColumnHeader.ReorderCompletedEvent, OnColumnReorderCompleted);
        AddHandler(ProDataGridColumnHeader.FreezeRequestedEvent, OnColumnFreezeRequested);

        // Listen to filter cell events (bubbled from ProDataGridFilterCell)
        AddHandler(ProDataGridFilterCell.FilterChangedEvent, OnFilterChanged);

        // Listen to group panel events
        AddHandler(ProDataGridGroupPanel.ColumnGroupedEvent, OnColumnGrouped);
        AddHandler(ProDataGridGroupPanel.ColumnUngroupedEvent, OnColumnUngrouped);
    ...
    private void OnSelectionManagerChanged(object? sender, ProControls.Models.DataGrid.SelectionChangedEventArgs e)
    {
    ...
    private void OnFilterChanged(object? sender, FilterChangedEventArgs e)
    {
        ...
        else
        {
            ...
            var filter = new Models.DataGrid.GridFilter
            {
                FieldName = e.Column.FieldName,
                Operator = Models.DataGrid.FilterOperator.Contains,
                Value = e.FilterText,
