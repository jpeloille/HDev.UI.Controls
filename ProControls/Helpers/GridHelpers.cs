...
public static class ColumnWidthHelper
{
    ...
    public static void CalculateColumnWidths(
        IEnumerable<Models.DataGrid.GridColumn> columns,
    ...
    public static double MeasureColumnWidth(
        Models.DataGrid.GridColumn column,
        IEnumerable<object> items,
        Func<object, Models.DataGrid.GridColumn, double> measureFunc,
        double headerWidth)
    {
...
public static class HitTestHelper
{
    ...
    /// </summary>
    public static (int RowIndex, Models.DataGrid.GridColumn? Column) GetCellAtPoint(
        Point point,
        IReadOnlyList<Models.DataGrid.GridColumn> columns,
        double rowHeight,
        double headerHeight,
        ...
        double scrollOffsetY)
    {
        ...
        double currentX = 0;
        Models.DataGrid.GridColumn? foundColumn = null;
